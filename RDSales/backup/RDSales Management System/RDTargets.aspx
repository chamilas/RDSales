<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RDTargets.aspx.cs" Inherits="RDSales_Management_System.RDTargets" %>
        ...
        <table class="style32">
            <tr>
                <td class="style27">
                    &nbsp;</td>
                <td class="style33">
                    <asp:Button ID="bttn_submit" runat="server" CssClass="ui-button" 
                        Text="Save" Width="80px" TabIndex="9" onclick="bttn_submit_Click" />
                </td>
                <td>
                    &nbsp;</td>
                <td class="style34">
